        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('roles.update', $rol->RolId) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="Descripcion" id="Descripcion" class="form-control" required>{{ $rol->Descripcion }}</textarea>
                                @error('Descripcion')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @php
                                    ...
                                    $rolePermissions = json_decode($rol->Permisos, true) ?: []; // Asegura que siempre sea un array
                                @endphp
                                    ...
                                    <div class="dropdown-container">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $loop->index }}">
                                            ...
                                            @foreach ($permissions as $permission)
                                                <div class="dropdown-item small-checkbox">
                                                    <div class="form-check">
                                                        <input class="form-check-input permiso" type="checkbox" name="Permisos[]" value="{{ $permission['value'] }}" id="permiso{{ $permission['value'] }}" {{ in_array($permission['value'], $rolePermissions) ? 'checked' : '' }}>
